            ...
            <body>
                ...
                <body>
                    ...
                    <table border="1" cellpadding="10">
                        ...
                        <?php while ($pelanggan = mysqli_fetch_assoc($query)) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_pelanggan.php?id=<?= $pelanggan['id_pelanggan']; ?>">Edit</a> |
                                    <a href="hapus_pelanggan.php?id=<?= $pelanggan['id_pelanggan']; ?>" onclick="return confirm('Yakin ingin hapus data ini?')">Hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
